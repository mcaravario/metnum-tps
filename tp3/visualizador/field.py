...
class Field(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.__goal1.rect.move_ip(100, height/2.0 - self.__goal1.image.get_size()[1]/2.0)
    ...
    def blitBackground(self, surface):
        ...
        ## centre line
        drawRect  (surface, line_color, [width-300-1, 0], [width-300+1, height])
        ## big circle in the middle
        drawCircle(surface, line_color, [width-300, height/2.0], 80)
        ## small circle where ball is
        drawCircle(surface, line_color, [width-300, height/2.0], 4,0)
        ## line behind goal 1
        goal1_pos = [self.getGoal1().rect.left, self.getGoal1().rect.top]
        anchoArco = self.getGoal1().image.get_size()[1]
        profArco = self.getGoal1().image.get_size()[0]
        drawRect  (surface, line_color, [goal1_pos[0]+profArco, 0], [goal1_pos[0]+profArco, height])
        #Area chica
        drawRect(surface, line_color, [goal1_pos[0]+anchoArco*(5.50/7.32)+profArco, goal1_pos[1]-anchoArco*(5.50/7.32)], [goal1_pos[0]+anchoArco*(5.50/7.32)+profArco, goal1_pos[1]+anchoArco+anchoArco*(5.50/7.32)])
        drawRect(surface, line_color, [goal1_pos[0]+profArco, goal1_pos[1]-anchoArco*(5.50/7.32)], [goal1_pos[0]++profArco+anchoArco*(5.50/7.32), goal1_pos[1]-anchoArco*(5.50/7.32)])
        drawRect(surface, line_color, [goal1_pos[0]+profArco, goal1_pos[1]+anchoArco+anchoArco*(5.50/7.32)], [goal1_pos[0]++profArco+anchoArco*(5.50/7.32), goal1_pos[1]+anchoArco+anchoArco*(5.50/7.32)])
        #Area grande
        drawRect(surface, line_color, [goal1_pos[0]+anchoArco*(16.50/7.32)+profArco, goal1_pos[1]-anchoArco*(16.50/7.32)], [goal1_pos[0]+anchoArco*(16.50/7.32)+profArco, goal1_pos[1]+anchoArco+anchoArco*(16.50/7.32)])
        drawRect(surface, line_color, [goal1_pos[0]+profArco, goal1_pos[1]-anchoArco*(16.50/7.32)], [goal1_pos[0]+anchoArco*(16.50/7.32)+profArco, goal1_pos[1]-anchoArco*(16.50/7.32)])
        drawRect(surface, line_color, [goal1_pos[0]+profArco, goal1_pos[1]+anchoArco+anchoArco*(16.50/7.32)], [goal1_pos[0]+anchoArco*(16.50/7.32)+profArco, goal1_pos[1]+anchoArco+anchoArco*(16.50/7.32)])
        #Penal
        drawCircle(surface, line_color, [goal1_pos[0]+anchoArco*(11/7.32)+profArco, goal1_pos[1]+anchoArco/2.0], 4,0)
        ## line behind goal 2
...
class Goal(pygame.sprite.Sprite):
    ...
    def __init__(self, direction):
        pygame.sprite.Sprite.__init__(self)
        self.image, self.rect = load_image(filepath="goal.bmp",scale=(25,70))
